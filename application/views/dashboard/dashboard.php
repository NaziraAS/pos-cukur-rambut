	...
	<div class="toolbar" id="kt_toolbar">
		...
		<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
			...
			<div class="d-flex align-items-center py-1">
				...
				<a href="#" class="btn btn-primary btn-sm fs-4"><i class="bi bi-currency-dollar fs-3 me-2"></i>Saldo</a>
				<!--end::Button-->
			</div>
			<!--end::Actions-->
		</div>
		...
		<div id="kt_content_container" class="container">
			...
			<div class="row gy-5 g-xl-8">
				...
				<div class="col-xxl-4">
					...
					<div class="card shadow-sm card-xxl-stretch mb-5">
						<div class="card-header">
							<span class="fw-bolder mb-2 text-dar card-title">Booking</span>
						</div>
						<div class="card-body p-0 text-center">
							<div class="card-p fs-5 fw-bold">Atur jadwal cukur semaumu? bisa klik booking sekarang</div>
							<div class="text-center px-4">
								<img class="mw-100 mh-300px card-rounded-bottom" alt="" src="<?= base_url() ?>assets/media/illustrations/booking-removebg-preview.png" />
							</div>
							<a href="#" class="btn btn-light-success">Booking</a>
						</div>
					</div>
					<!--end::Mixed Widget 2-->
				</div>
				...
				<div class="col-xxl-4">
					...
					<div class="card shadow-sm card-xxl-stretch mb-5">
						<div class="card-header">
							<span class="fw-bolder mb-2 text-dar card-title">Promo</span>
						</div>
						<div class="card-body p-0 text-center">
							<div class="card-p fs-5 fw-bold">Atur Discount semaumu! sesuka hatimu, Klik Discount di bawah</div>
							<div class="text-center px-4">
								<img class="mw-100 mh-300px card-rounded-bottom" alt="" src="<?= base_url() ?>assets/media/illustrations/Retail markdown-pana.png" />
							</div>
							<a href="#" class="btn btn-light-success">Discount</a>
						</div>
					</div>
					<!--end::Mixed Widget 2-->
				</div>
