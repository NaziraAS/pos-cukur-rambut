				...
				<div class="d-flex flex-column flex-lg-row-auto w-xl-600px positon-xl-relative" style="background-color: #F2C98A">
					...
					<div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
						...
						<div class="d-flex flex-row-fluid flex-column text-center pt-lg-20">
							<!--begin::Logo-->
							<a href="../../demo5/dist/index.html" class="">
								<img alt="Logo" src="<?= base_url() ?>assets/media/illustrations/logo-barbershop.png" class="h-100px" />
								<!-- style="width:250px; margin-top:-60px;" -->
							</a>
							<!--end::Logo-->
							<!--begin::Title-->
							<h1 class="fw-bolder fs-2qx pb-5 pb-md-10" style="color: #986923;">Welcome to BarbarShop</h1>
							<!--end::Title-->
							<!--begin::Description-->
							<p class="fw-bold fs-2" style="color: #986923;">Potong rambut rapi & terbaik sesukamu?
								<br />disini aja!
							</p>
							<!--end::Description-->
						</div>
						<!--end::Content-->
						<!--begin::Illustration-->
						<div class="d-flex flex-row-auto bgi-no-repeat bgi-position-x-center bgi-size-contain bgi-position-y-bottom min-h-100px min-h-lg-350px" style="background-image: url(<?= base_url() ?>assets/media/illustrations/barbershop-1-removebg.png)"></div>
						<!--end::Illustration-->
					</div>
					<!--end::Wrapper-->
				</div>
						...
						<div class="w-lg-500px p-10 p-lg-15 mx-auto">
							...
							<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="#">
								...
								<div class="text-center mb-10">
									<!--begin::Title-->
									<h1 class="text-dark mb-3">Sign In to BarbarShop</h1>
									<!--end::Title-->
									<!--begin::Link-->
									<div class="text-gray-400 fw-bold fs-4">Baru kesini?
										<a href="../../demo5/dist/authentication/flows/aside/sign-up.html" class="link-primary fw-bolder">Buat Akun</a>
									</div>
									<!--end::Link-->
								</div>
								<!--begin::Heading-->
								...
								<div class="fv-row mb-10">
									...
									<div class="d-flex flex-stack mb-2">
										...
										<!--end::Label-->
										<!--begin::Link-->
										<a href="../../demo5/dist/authentication/flows/aside/password-reset.html" class="link-primary fs-6 fw-bolder">Lupa Password ?</a>
										<!--end::Link-->
									</div>
									<!--end::Wrapper-->
									<!--begin::Input-->
